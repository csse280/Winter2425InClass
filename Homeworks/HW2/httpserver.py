...
def handle_special_routes(file_name, post_data):
    ...
    elif file_name == "/API/NEWGAME":
        # TODO: Make a random board and return JSON.
        sample_json = {
            "board": "0011100",
            "isWon": False,
            "numMoves": 0
    ...
    elif file_name == "/API/PRESSINDEX":
        # TODO: Make a random board and return JSON.
        print(post_data)
        press_index = post_data.pressIndex
        board = post_data.board
        num_moves = post_data.numMoves
        # TODO: Figure out the next state.
        sample_json = {
            "board": "0011100",
            "isWon": False,
            "numMoves": 0
